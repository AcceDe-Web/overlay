...
(function(window, document, exportName) {
  ...
  var Modal = {
    ...
    findInteractiveElement: function( modal ){
      ...
      if( !modal.firstInteractiveElement ){
        // fallback on the first close button or the modal itself
        modal.firstInteractiveElement = firstCloseBtn || modal;

        // set the tabindex on the modal if it become the focusable element
        if( modal.options.role && modal === modal.firstInteractiveElement ){
